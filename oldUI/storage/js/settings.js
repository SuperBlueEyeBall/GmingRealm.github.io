...
function populateCustomThemeSettings() {
    ...
    document.getElementById('background-image').value = customTheme['background-image'] || 'https://raw.githubusercontent.com/a456pur/GmingRealm/main/images/backgrounds/GmingRealm/homebg.png';
...
document.getElementById('export-theme').addEventListener('click', function() {
    ...
    document.getElementById('save-theme').addEventListener('click', function() {
        ...
        a.href = url;
        a.download = `GmingRealm-${themeName}.theme`;
